<template>
	<div>
		<el-card>
			<el-card class="box-card1">
				<el-breadcrumb separator-class="el-icon-arrow-right">
					...
					<el-breadcrumb-item :to="{ path: '/' }">接口管理</el-breadcrumb-item>
			...
			<el-card class="box-card2">
					...
					<el-form :inline="true" class="demo-form-inline">
						<el-form-item label="项目名称">
							<el-select v-model="value" placeholder="请选择项目">
								<el-option v-for="item in tableData" :key="item.name" :label="item.name"
									:value="item.name">
								</el-option>
							</el-select>
						</el-form-item>
						<el-form-item>
							<el-input v-model="formInline" placeholder="请输入接口名称"></el-input>
						</el-form-item>
						<el-form-item>
				...
				<el-table :data="tableData" stripe style="width: 100%" :header-cell-style="tablestyle"
					...
					<el-table-column prop="contactUser" label="请求方式" width="180">
					</el-table-column>
					<el-table-column prop="email" label="接口地址">
					</el-table-column>
		...
		<el-dialog title="新增接口信息" :visible.sync="newadddialogFormVisible">
			<el-form :model="newadduser" ref="editinref" :rules="rules">
				...
				<el-form-item label="请求方式" :label-width="formLabelWidth" prop="contactUser">
					<el-input v-model="newadduser.contactUser" autocomplete="off"></el-input>
				</el-form-item>
				<el-form-item label="接口地址" :label-width="formLabelWidth" prop="email">
		...
		<el-dialog title="编辑接口信息" :visible.sync="dialogFormVisible">
			<el-form :model="form" ref="editinref" :rules="rules">
				<el-form-item label="LOGO" :label-width="formLabelWidth">
					<div class="avatar-uploader">
						<el-upload action="https://ali-consoleapi.idoocloud.com/api/image/device/upload"
